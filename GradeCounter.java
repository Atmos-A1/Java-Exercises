...
public class GradeCounter{
	...
	for(int numberOfStudent = 1;  numberOfStudent <= numberOfStudents; numberOfStudent++){
		...
		System.out.printf("The grade of %s is :  ", nameOfStudent);

		String gradeOfStudent = input.next();

		System.out.println();

		System.out.printf("The remark of the user is: ");
		String gradeRemark = input.next();

		System.out.println();

		System.out.printf("%s's grade is %s, hence the remark is %s%n", nameOfStudent, gradeOfStudent, gradeRemark);

		System.out.println();

		System.out.printf("The score of  % is %"
