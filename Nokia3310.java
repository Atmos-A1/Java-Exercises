...
""";
	...
	""";
		...
		case 99 : System.out.println("Going to previous menu");
...
""";
	...
	""";
					...
					MessageSettingsMenuChoice = inputCollector.nextInt();
						...
						switch(MessageSettingsMenuChoice){
							...
							Enter 1 for  Message Center Number
	...
	""";
		...
		""";
			...
			int callDurationChoices = inputCollector.nextInt();
...
""";
						...
						int showCallCostOptions = inputCollector.nextInt();
...
""";
					...
					int callCostOptions = inputCollector.nextInt();
			...
			default: System.out.println("Press a valid Key"); break;
				...
				} while(callRegisterMenuChoice != 99);
...
""";
		...
		int toneOptionsMenu = inputCollector.nextInt();
	...
	""";
			...
			int SettingsFolderSubMenu = inputCollector.nextInt();
...
""";
	...
	""";
		...
		case 99 : System.out.println("You have exited nokia"); break;
